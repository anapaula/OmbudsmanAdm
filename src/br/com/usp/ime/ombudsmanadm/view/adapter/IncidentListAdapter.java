...
public class IncidentListAdapter extends BaseAdapter {
	...
	public View getView(int index, View convertView, ViewGroup group) {
		View view = activity.getLayoutInflater().inflate(R.layout.activity_incident_list_item, null);
		...
		TextView status = (TextView)view.findViewById(R.id.incident_list_item_status);
