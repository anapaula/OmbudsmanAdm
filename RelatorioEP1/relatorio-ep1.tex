...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Relatório do aplicativo\\ Ouvidoria móvel da USP}}\\
        
    \vspace*{1.2cm}
    \Large{Ana Paula Oliveira Bertholdo\\Rafael Brito de Oliveira\\Suelen Goularte de Carvalho}
    
    \vskip 2cm
    \textsc{
    Relatório do aplicativo \\[-0.25cm]     
    Ouvidoria móvel da\\[-0.25cm]
    ...
    \vskip 0.5cm
    \normalsize{São Paulo, abril de 2014}
\end{center}
...
\input cap-manual-usuario    % associado ao arquivo: 'cap-manual-usuario.tex'
\input cap-estrutura-codigo  % associado ao arquivo: 'cap-estrutura-codigo.tex'
